...
import com.google.collegeadminapp.widget.LoadingDialog
...
fun ManageBanner(navController: NavController){
    ...
    val isUploaded by bannerViewModel.isPosted.observeAsState()
    val isDeleted by bannerViewModel.isDeleted.observeAsState()
    ...
    Scaffold (topBar ={ TopAppBar(title = { Text(text = "Manage Banner")}, colors = TopAppBarDefaults.largeTopAppBarColors(containerColor = Purple80), navigationIcon = { IconButton(
...
ElevatedCard(modifier = Modifier.padding(8.dp)) {
    Image(painter = rememberAsyncImagePainter(model = imageUri), contentDescription = "banner image", modifier = Modifier
        .height(220.dp)
    ...
    Row {
        ...
        OutlinedButton(onClick = {imageUri=null}, modifier = Modifier
            .fillMaxWidth()
            .weight(1f)
            .padding(4.dp)) {
            Text(text = "Cancel")
