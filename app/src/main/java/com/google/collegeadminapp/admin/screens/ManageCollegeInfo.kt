...
fun ManageCollegeInfo(navController:NavController) {
    ...
    val isUploaded by collegeInfoViewModel.isPosted.observeAsState()
    ...
    Scaffold(topBar = {
        ...
        Column(modifier = Modifier.padding(padding)) {
            ...
            ElevatedCard(modifier = Modifier.padding(8.dp)) {
                ...
                OutlinedTextField(value = desc, onValueChange = { desc = it }, placeholder = {
                    Text(text = "College desc...")
                }, modifier = Modifier
                    .fillMaxWidth()
                    .padding(4.dp)
                )
                OutlinedTextField(value = address, onValueChange = { address = it }, placeholder = {
                ...
                Image(
                    painter = if (imageUrl != "") rememberAsyncImagePainter(model = imageUrl) else if (imageUri == null) painterResource(
                        ...
                        model = imageUri
                    ), contentDescription = "banner image", modifier = Modifier
                        .height(220.dp)
                        .fillMaxWidth()
                        .clickable {
