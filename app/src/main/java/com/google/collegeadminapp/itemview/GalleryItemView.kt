...
@Composable
fun GalleryItemView(galleryModel: GalleryModel,delete:(galleryModel:GalleryModel)->Unit,deleteImage:(cat:String,image:String)->Unit) {
...
ConstraintLayout(modifier = Modifier.fillMaxWidth()) {
    ...
    Text(text = galleryModel.category!!, modifier = Modifier
        ...
        LazyRow( ){
            items(galleryModel.images?: emptyList()){
                ImageItemView(imageUrl = it,cat=galleryModel.category!!, delete ={
                        cat,imageUrl ->  deleteImage(cat,imageUrl)
                } )
            }
